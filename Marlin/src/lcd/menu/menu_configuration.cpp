...
void menu_advanced_settings();
  ...
  void menu_config_retract() {
    ...
    EDIT_ITEM(float52sign, MSG_CONTROL_RETRACT_ZHOP, &fwretract.settings.retract_zraise, 0, 10);
    EDIT_ITEM(float52sign, MSG_CONTROL_RETRACT_RECOVER, &fwretract.settings.retract_recover_extra, -10, 10);
    #if HAS_MULTI_EXTRUDER
